package com.example.hanny.recyclerviewjson;
...
import com.example.hanny.recyclerviewjson.adapter.RestaurantAdapter;
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                for (int i = 0; i < restaurantsArray.length(); i++) {
                    ...
                    restaurant.setLattitude(lat);
                    restaurant.setLongtitude(lon);
